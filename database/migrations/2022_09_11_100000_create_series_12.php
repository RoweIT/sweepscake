...
return new class extends Migration {
    ...
    public function up()
    {
        $series12 = Series::create(['slug' => 'gbbo-series-12', 'name' => 'Great British Bake Off 2021 (series 12)',
            'start_on' => new Carbon('2021-09-12'), 'status' => Series::STATUS_COMPLETE, 'image_path' => 'series/gbbo-series-12-640.jpg']);

        $amanda = Baker::create(['slug' => 'amanda-12', 'name' => 'Amanda', 'age' => 56, 'from' => 'London',
        ...
        $chigs = Baker::create(['slug' => 'chigs-12', 'name' => 'Chigs', 'age' => 40, 'from' => 'Leicestershire',
        ...
        $crystelle = Baker::create(['slug' => 'crystelle-12', 'name' => 'Crystelle', 'age' => 26, 'from' => 'London',
        ...
        $freya = Baker::create(['slug' => 'freya-12', 'name' => 'Freya', 'age' => 19, 'from' => 'North Yorkshire',
        ...
        $george = Baker::create(['slug' => 'george-12', 'name' => 'George', 'age' => 34, 'from' => 'London',
        ...
        $giuseppe = Baker::create(['slug' => 'giuseppe-12', 'name' => 'Giuseppe', 'age' => 45, 'from' => 'Bristol',
        ...
        $jairzeno = Baker::create(['slug' => 'jairzeno-12', 'name' => 'Jairzeno', 'age' => 51, 'from' => 'London',
        ...
        $jurgen = Baker::create(['slug' => 'jurgen-12', 'name' => 'Jurgen', 'age' => 56, 'from' => 'Sussex',
        ...
        $lizzie = Baker::create(['slug' => 'lizzie-12', 'name' => 'Lizzie', 'age' => 28, 'from' => 'Liverpool',
        ...
        $maggie = Baker::create(['slug' => 'maggie-12', 'name' => 'Maggie', 'age' => 70, 'from' => 'Dorset',
        ...
        $rochica = Baker::create(['slug' => 'rochica-12', 'name' => 'Rochica', 'age' => 27, 'from' => 'Birmingham',
        ...
        $tom = Baker::create(['slug' => 'tom-12', 'name' => 'Tom', 'age' => 28, 'from' => 'Kent',
