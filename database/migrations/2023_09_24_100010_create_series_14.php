...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        $abbi = Baker::create([
            'slug' => 'abbi-14', 'name' => 'Abbi', 'age' => 27, 'from' => '',
            'job' => '', 'image_path' => 'bakers/2023/abbi.avif', 'series_id' => $series14->id,
        ...
        $amos = Baker::create([
            'slug' => 'amos-14', 'name' => 'Amos', 'age' => 59, 'from' => '',
            'job' => '', 'image_path' => 'bakers/2023/amos.avif', 'series_id' => $series14->id,
        ...
        $cristy = Baker::create([
            'slug' => 'cristy-14', 'name' => 'Cristy', 'age' => 33, 'from' => '',
            'job' => '', 'image_path' => 'bakers/2023/cristy.avif', 'series_id' => $series14->id,
        ...
        $dan = Baker::create([
            'slug' => 'dan-14', 'name' => 'Dan', 'age' => 42, 'from' => '',
            'job' => '', 'image_path' => 'bakers/2023/dan.avif', 'series_id' => $series14->id,
        ...
        $dana = Baker::create([
            'slug' => 'dana-14', 'name' => 'Dana', 'age' => 25, 'from' => '',
            'job' => '', 'image_path' => 'bakers/2023/dana.avif', 'series_id' => $series14->id,
        ...
        $josh = Baker::create([
            'slug' => 'josh-14', 'name' => 'Josh', 'age' => 27, 'from' => '',
            'job' => '', 'image_path' => 'bakers/2023/josh.avif', 'series_id' => $series14->id,
        ...
        $keith = Baker::create([
            'slug' => 'keith-14', 'name' => 'Keith', 'age' => 60, 'from' => '',
            'job' => '', 'image_path' => 'bakers/2023/keith.avif', 'series_id' => $series14->id,
        ...
        $matty = Baker::create([
            'slug' => 'matty-14', 'name' => 'Matty', 'age' => 28, 'from' => '',
            'job' => '', 'image_path' => 'bakers/2023/matty.avif', 'series_id' => $series14->id,
        ...
        $nicky = Baker::create([
            'slug' => 'nicky-14', 'name' => 'Nicky', 'age' => 52, 'from' => '',
            'job' => '', 'image_path' => 'bakers/2023/nicky.avif', 'series_id' => $series14->id,
        ...
        $rowan = Baker::create([
            'slug' => 'rowan-14', 'name' => 'Rowan', 'age' => 21, 'from' => '',
            'job' => '', 'image_path' => 'bakers/2023/rowan.avif', 'series_id' => $series14->id,
        ...
        $saku = Baker::create([
            'slug' => 'saku-14', 'name' => 'Saku', 'age' => 50, 'from' => '',
            'job' => '', 'image_path' => 'bakers/2023/saku.avif', 'series_id' => $series14->id,
        ...
        $tasha = Baker::create([
            'slug' => 'tasha-14', 'name' => 'Tasha', 'age' => 27, 'from' => '',
            'job' => '', 'image_path' => 'bakers/2023/tasha.avif', 'series_id' => $series14->id,
