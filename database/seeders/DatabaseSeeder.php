...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->command->info("Created admin Admin user, name: $admin->name and password: $adminPassword");
        ...
        $amanda = Baker::create(['slug' => 'amanda-21', 'name' => 'Amanda', 'age' => 56, 'from' => 'London',
            'job' => 'Met Police Detective', 'image_path' => 'bakers/2021/amanda.jpg', 'series_id' => $series21->id,
        ...
        $chigs = Baker::create(['slug' => 'chigs-21', 'name' => 'Chigs', 'age' => 40, 'from' => 'Leicestershire',
            'job' => 'Sales Manager', 'image_path' => 'bakers/2021/chigs.jpg', 'series_id' => $series21->id,
        ...
        $crystelle = Baker::create(['slug' => 'crystelle-21', 'name' => 'Crystelle', 'age' => 26, 'from' => 'London',
            'job' => 'Client Relationship Manager', 'image_path' => 'bakers/2021/crystelle.jpg', 'series_id' => $series21->id,
        ...
        $freya = Baker::create(['slug' => 'freya-21', 'name' => 'Freya', 'age' => 19, 'from' => 'North Yorkshire',
            'job' => 'Student', 'image_path' => 'bakers/2021/freya.jpg', 'series_id' => $series21->id,
        ...
        $george = Baker::create(['slug' => 'george-21', 'name' => 'George', 'age' => 34, 'from' => 'London',
            'job' => 'Shared Lives Co-ordinator', 'image_path' => 'bakers/2021/george.jpg', 'series_id' => $series21->id,
        ...
        $giuseppe = Baker::create(['slug' => 'giuseppe-21', 'name' => 'Giuseppe', 'age' => 45, 'from' => 'Bristol',
            'job' => 'Chief Engineer', 'image_path' => 'bakers/2021/giuseppe.jpg', 'series_id' => $series21->id,
        ...
        $jairzeno = Baker::create(['slug' => 'jairzeno-21', 'name' => 'Jairzeno', 'age' => 51, 'from' => 'London',
            'job' => 'Head of Finance', 'image_path' => 'bakers/2021/jairzeno.jpg', 'series_id' => $series21->id,
        ...
        $jurgen = Baker::create(['slug' => 'jurgen-21', 'name' => 'Jurgen', 'age' => 56, 'from' => 'Sussex',
            'job' => 'IT Professional', 'image_path' => 'bakers/2021/jurgen.jpg', 'series_id' => $series21->id,
        ...
        $lizzie = Baker::create(['slug' => 'lizzie-21', 'name' => 'Lizzie', 'age' => 28, 'from' => 'Liverpool',
            'job' => 'Car Production Operative', 'image_path' => 'bakers/2021/lizzie.jpg', 'series_id' => $series21->id,
        ...
        $maggie = Baker::create(['slug' => 'maggie-21', 'name' => 'Maggie', 'age' => 70, 'from' => 'Dorset',
            'job' => 'Retired Nurse and Midwife', 'image_path' => 'bakers/2021/maggie.jpg', 'series_id' => $series21->id,
        ...
        $rochica = Baker::create(['slug' => 'rochica-21', 'name' => 'Rochica', 'age' => 27, 'from' => 'Birmingham',
            'job' => 'Junior HR Business Partner', 'image_path' => 'bakers/2021/rochica.jpg', 'series_id' => $series21->id,
        ...
        $tom = Baker::create(['slug' => 'tom-21', 'name' => 'Tom', 'age' => 28, 'from' => 'Kent',
            'job' => 'Software Developer', 'image_path' => 'bakers/2021/tom.jpg', 'series_id' => $series21->id,
        ...
        $abdul = Baker::create(['slug' => 'abdul-22', 'name' => 'Abdul', 'age' => 29, 'from' => 'London',
            'job' => 'Electronics Engineer', 'image_path' => 'bakers/2022/abdul.jpg', 'series_id' => $series22->id,
        ...
        $carole = Baker::create(['slug' => 'carole-22', 'name' => 'Carole', 'age' => 59, 'from' => 'Dorset',
            'job' => 'Supermarket Cashier', 'image_path' => 'bakers/2022/carole.jpg', 'series_id' => $series22->id,
        ...
        $dawn = Baker::create(['slug' => 'dawn-22', 'name' => 'Dawn', 'age' => 60, 'from' => 'Bedfordshire',
            'job' => 'IT Manager', 'image_path' => 'bakers/2022/dawn.jpg', 'series_id' => $series22->id,
        ...
        $james = Baker::create(['slug' => 'james-22', 'name' => 'James', 'age' => 25, 'from' => 'Cumbria',
            'job' => 'Nuclear Scientist', 'image_path' => 'bakers/2022/james.jpg', 'series_id' => $series22->id,
        ...
        $janusz = Baker::create(['slug' => 'janusz-22', 'name' => 'Janusz', 'age' => 34, 'from' => 'East Sussex',
            'job' => 'Headteachers PA', 'image_path' => 'bakers/2022/janusz.jpg', 'series_id' => $series22->id,
        ...
        $kevin = Baker::create(['slug' => 'kevin-22', 'name' => 'Kevin', 'age' => 33, 'from' => 'East Lanarkshire'
            , 'job' => 'Music Teacher', 'image_path' => 'bakers/2022/kevin.jpg', 'series_id' => $series22->id,
        ...
        $maisam = Baker::create(['slug' => 'maisam-22', 'name' => 'Maisam', 'age' => 18, 'from' => 'Manchester',
            'job' => 'Student', 'image_path' => 'bakers/2022/mainsam.jpg', 'series_id' => $series22->id,
        ...
        $maxy = Baker::create(['slug' => 'maxy-22', 'name' => 'Maxy', 'age' => 29, 'from' => 'London',
            'job' => 'Achitectural Assistant', 'image_path' => 'bakers/2022/maxy.jpg', 'series_id' => $series22->id,
        ...
        $rebs = Baker::create(['slug' => 'rebs-22', 'name' => 'Rebs', 'age' => 23, 'from' => 'County Antrim',
            'job' => 'Masters Student', 'image_path' => 'bakers/2022/rebs.jpg', 'series_id' => $series22->id,
        ...
        $sandro = Baker::create(['slug' => 'sandro-22', 'name' => 'Sandro', 'age' => 30, 'from' => 'London',
            'job' => 'Nanny', 'image_path' => 'bakers/2022/sandro.jpg', 'series_id' => $series22->id,
        ...
        $syabira = Baker::create(['slug' => 'syabira-22', 'name' => 'Syabira', 'age' => 32, 'from' => 'London',
            'job' => 'Cardiovascular Research Associate', 'image_path' => 'bakers/2022/syabira.jpg', 'series_id' => $series22->id,
        ...
        $will = Baker::create(['slug' => 'will-22', 'name' => 'Will', 'age' => 45, 'from' => 'London',
            'job' => 'Former Charity Director', 'image_path' => 'bakers/2022/will.jpg', 'series_id' => $series22->id,
